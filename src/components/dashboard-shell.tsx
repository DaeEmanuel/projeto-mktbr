...
export function DashboardShell({
  ...
  return (
    <main className="min-h-screen bg-[#f4f8f3] text-[#061421] lg:pl-80">
      <aside className="border-b border-white/10 bg-[#05281f] text-white shadow-2xl lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex lg:h-screen lg:max-h-screen lg:w-80 lg:flex-col lg:overflow-hidden lg:border-b-0 lg:border-r lg:border-white/10">
        ...
        <div className="mt-auto hidden shrink-0 border-t border-white/10 bg-[#05281f] p-6 lg:block">
